...
public class MotorPHpayrollSystem {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (col[0].trim().equals(empNum)) {
                    found = true;
                    System.out.println("Employee Number : " + col[0].trim());
                    System.out.println("Employee Name   : " + col[2].trim() + " " + col[1].trim());
                    System.out.println("Birthday        : " + col[3].trim());
                    break;
                }
            }
    ...
    public static double computePagIbig(double monthlySalary) {
        ...
        return Math.min(monthlySalary * rate, 100);
    }
